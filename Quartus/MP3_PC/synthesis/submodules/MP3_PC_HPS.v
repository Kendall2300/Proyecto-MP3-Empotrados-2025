...
module MP3_PC_HPS #(
		...
		output wire        h2f_sdmmc_irq,        // h2f_sdmmc_interrupt.irq
	...
	MP3_PC_HPS_fpga_interfaces fpga_interfaces (
		...
		.f2h_sdram0_ARADDR  (f2h_sdram0_ARADDR),  //     f2h_sdram0_data.araddr
		.f2h_sdram0_ARLEN   (f2h_sdram0_ARLEN),   //                    .arlen
		.f2h_sdram0_ARID    (f2h_sdram0_ARID),    //                    .arid
		.f2h_sdram0_ARSIZE  (f2h_sdram0_ARSIZE),  //                    .arsize
		.f2h_sdram0_ARBURST (f2h_sdram0_ARBURST), //                    .arburst
		.f2h_sdram0_ARLOCK  (f2h_sdram0_ARLOCK),  //                    .arlock
		.f2h_sdram0_ARPROT  (f2h_sdram0_ARPROT),  //                    .arprot
		.f2h_sdram0_ARVALID (f2h_sdram0_ARVALID), //                    .arvalid
		.f2h_sdram0_ARCACHE (f2h_sdram0_ARCACHE), //                    .arcache
		.f2h_sdram0_AWADDR  (f2h_sdram0_AWADDR),  //                    .awaddr
		.f2h_sdram0_AWLEN   (f2h_sdram0_AWLEN),   //                    .awlen
		.f2h_sdram0_AWID    (f2h_sdram0_AWID),    //                    .awid
		.f2h_sdram0_AWSIZE  (f2h_sdram0_AWSIZE),  //                    .awsize
		.f2h_sdram0_AWBURST (f2h_sdram0_AWBURST), //                    .awburst
		.f2h_sdram0_AWLOCK  (f2h_sdram0_AWLOCK),  //                    .awlock
		.f2h_sdram0_AWPROT  (f2h_sdram0_AWPROT),  //                    .awprot
		.f2h_sdram0_AWVALID (f2h_sdram0_AWVALID), //                    .awvalid
		.f2h_sdram0_AWCACHE (f2h_sdram0_AWCACHE), //                    .awcache
		.f2h_sdram0_BRESP   (f2h_sdram0_BRESP),   //                    .bresp
		.f2h_sdram0_BID     (f2h_sdram0_BID),     //                    .bid
		.f2h_sdram0_BVALID  (f2h_sdram0_BVALID),  //                    .bvalid
		.f2h_sdram0_BREADY  (f2h_sdram0_BREADY),  //                    .bready
		.f2h_sdram0_ARREADY (f2h_sdram0_ARREADY), //                    .arready
		.f2h_sdram0_AWREADY (f2h_sdram0_AWREADY), //                    .awready
		.f2h_sdram0_RREADY  (f2h_sdram0_RREADY),  //                    .rready
		.f2h_sdram0_RDATA   (f2h_sdram0_RDATA),   //                    .rdata
		.f2h_sdram0_RRESP   (f2h_sdram0_RRESP),   //                    .rresp
		.f2h_sdram0_RLAST   (f2h_sdram0_RLAST),   //                    .rlast
		.f2h_sdram0_RID     (f2h_sdram0_RID),     //                    .rid
		.f2h_sdram0_RVALID  (f2h_sdram0_RVALID),  //                    .rvalid
		.f2h_sdram0_WLAST   (f2h_sdram0_WLAST),   //                    .wlast
		.f2h_sdram0_WVALID  (f2h_sdram0_WVALID),  //                    .wvalid
		.f2h_sdram0_WDATA   (f2h_sdram0_WDATA),   //                    .wdata
		...
		.h2f_sdmmc_irq      (h2f_sdmmc_irq)       // h2f_sdmmc_interrupt.irq
	);

	MP3_PC_HPS_hps_io hps_io (
